    ...
    public static class Easing
    {
        ...
        public static float EaseIn(double linearStep, EasingType type)
        {
            switch (type)
            {
                ...
                case EasingType.Quintic: return Power.EaseIn(linearStep, (int)type);
            }
        ...
        public static float EaseOut(double linearStep, EasingType type)
        {
            switch (type)
            {
                ...
                case EasingType.Quintic: return Power.EaseOut(linearStep, (int)type);
            }
            throw new NotImplementedException();
        }
        ...
        public static float EaseInOut(double linearStep, EasingType type)
        {
            switch (type)
            {
                ...
                case EasingType.Quintic: return Power.EaseInOut(linearStep, (int)type);
            }
            throw new NotImplementedException();
        }
        ...
        static class Sine
        {
            ...
            {
                return (float)Math.Sin(s * EasingHelper.HalfPi - EasingHelper.HalfPi) + 1;
            }
            public static float EaseOut(double s)
            {
                return (float)Math.Sin(s * EasingHelper.HalfPi);
            }
            public static float EaseInOut(double s)
            {
                return (float)(Math.Sin(s * EasingHelper.Pi - EasingHelper.HalfPi) + 1) / 2;
            }
        }
